<?php
/*
	Renvoie un état descriptif du parnier.
	Variable disponible
		$this->currentCartContent (tableau associatif).
			array(
				['TOTAL_ITEMS']	(nombre de total de contenu du parnier
				['TOTAL_PRICES']	(prix total des contenu du parnier & autres charges)
				['DEVISE']	(devise choisi pour l'élément)
				['ITEM_LIST']	(tableau associatif avec tous les éléments détaillé du parnier)
					array(
						['TITLE']	(titre de l'élément)
						['QUANTITY']	(quantité de l'élément)
						['UNIQUE_PRICE']	(prix unitaire)
						['GLOBAL_PRICE'] (prix total des éléments additionné).
						['ADD_LINK']	(lien vers ajout d'élément)
						['ADD_TEXT']	(text du lien)
						['REMOVE_LINK']	(lien vers le retrait d'un élément)
						['REMOVE_TEXT']	(texte du lien)
					)
				['CART_LINK']	(lien vers le panier)
				['CART_TEXT']	(texte du lien)
			);
*/
